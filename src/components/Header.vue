    ...
    <div class="flex justify-between items-center py-8 border-b">
      ...
      <div class="flex justify-between items-center gap-6">
        ...
        <div class="relative pr-2">
          ...
          <div class="font-serif absolute px-[5px] border-[3px] rounded-full text-[#fff] bg-[#46A358] text-[10px] top-[-4px] right-[-2px]">6</div>
        </div>
        <button class="bg-[#46A358] flex items-center gap-2 px-5 py-2 rounded-[6px]" @click="emitLogin">
